...
* an amazing trick by [Mathias (1996)](https://doi.org/10.1137/S0895479895283409): $f( \begin{bmatrix} A & dA \\ & A \end{bmatrix}) = \begin{bmatrix} f(A) & f'(A)[dA] \\ & f(A) \end{bmatrix}$ for any analytic/smooth function f(A) acting on square matrices.  (e.g. matrix powers/polynomials, matrix exponentials, etcetera).
