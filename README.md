...
* an amazing trick by [Mathias (1996)](https://doi.org/10.1137/S0895479895283409): $f( \left[ \begin{array}{ccc} A & dA \\ & A \end{array} \right]) = \left[ \begin{array}{ccc} f(A) & f'(A)[dA] \\ & f(A) \end{array} \right]$ for any analytic/smooth function f(A) acting on square matrices.  (e.g. matrix powers/polynomials, matrix exponentials, etcetera).
